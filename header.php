...
<body>
    <div class="container">
        <div class="row">
            <div class="col">
                <p class="header_top">人には人にしかできない仕事がある</p>
            </div>
        </div>
    </div>
    <!-- Navbar Menu -->
    <header class="border_class">
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light">
                <a class="navbar-brand" href="#"><img src="img/logo_amiebot.png" alt="logo"></a>
